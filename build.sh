...
xcrun swiftc -swift-version 5 -O -target arm64-apple-macos15.2 Sources/*.swift -o "MacDuo.app/Contents/MacOS/DuoFoldDesktop" -framework Cocoa -framework MetalKit -framework ScreenCaptureKit -framework AVFoundation -framework IOKit
