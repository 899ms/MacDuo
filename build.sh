...
<?xml version="1.0" encoding="UTF-8"?><!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "http://www.apple.com/DTDs/PropertyList-1.0.dtd"><plist version="1.0"><dict><key>CFBundleExecutable</key><string>DuoFoldDesktop</string><key>CFBundleIdentifier</key><string>com.berryxia.duofold.desktop.v1</string><key>CFBundleName</key><string>MacDuo</string><key>CFBundleDisplayName</key><string>MacDuo</string><key>CFBundleIconFile</key><string>MacDuo</string><key>CFBundleVersion</key><string>1201</string><key>CFBundlePackageType</key><string>APPL</string><key>CFBundleShortVersionString</key><string>1.2.1</string><key>LSMinimumSystemVersion</key><string>15.2</string><key>NSCameraUsageDescription</key><string>注视模式使用内置摄像头在本机判断您是否面向屏幕，转开时显示毛玻璃。不保存或上传摄像头画面。</string><key>NSHighResolutionCapable</key><true/></dict></plist>
PLIST
